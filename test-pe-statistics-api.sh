...
# PE统计功能API测试脚本
# 使用前请先设置正确的服务器地址和JWT Token

# 配置
BASE_URL="http://localhost:8080/pe/admin/statistics"
# 请替换为实际的JWT Token
SCHOOL_ADMIN_TOKEN="your_school_admin_jwt_token_here"
COLLEGE_ADMIN_TOKEN="your_college_admin_jwt_token_here"
