...
public class CheckUserService {
    ...
    @Value("${app.checkuser.url}")
    private String checkDbUrl;
    @Value("${app.checkuser.username}")
    private String dbUser;
    @Value("${app.checkuser.password}")
    ...
    public Optional<CheckStudentInfo> validateStudent(String studentId, String school, String name) {
        String sql = "SELECT school, college, studentid, name, gender FROM checkstudent WHERE studentid = ? AND school = ? AND name = ?";

        try (Connection conn = DriverManager.getConnection(checkDbUrl, dbUser, dbPassword);
